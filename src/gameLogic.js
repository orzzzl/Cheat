...
.factory('gameLogic', function() {
  ...
  /**
   * Get all possible ranks for claiming.
   * If the input rank is undefined, then all ranks will be return,
   * otherwise, return a rank which is 1 close to the rank or the rank itself.
   * @param rank
   * @return {Array}
   */
